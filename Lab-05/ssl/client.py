...
context.verify_mode = ssl.CERT_NONE  # Tắt chế độ kiểm tra chứng chỉ (có thể điều chỉnh theo nhu cầu)
context.check_hostname = False  # Không kiểm tra tên host (có thể thay đổi tùy nhu cầu)

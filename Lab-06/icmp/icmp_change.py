...
# Hàm này được gọi mỗi khi bắt được một gói tin. Nếu gói tin chứa lớp ICMP, 
# hàm sẽ in ra thông tin của gói tin gốc, tạo một bản sao của gói tin với các trường IP được đảo 
# ngược (nguồn và đích hoán đổi) và thay đổi dữ liệu tải (payload) thành một chuỗi mới, 
# sau đó gửi gói tin đã được chỉnh sửa đi.
def modify_icmp_packet(packet):
    if packet.haslayer(ICMP):
        ...
        # Gói tin mới được tạo bằng cách sử dụng lớp IP và ICMP của Scapy
